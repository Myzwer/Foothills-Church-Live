...
This theme is designed to work for foothills church online and supply the needs of that website, but if you'd like to use it the instructions are below.
...
$ git clone - https://github.com/Myzwer/Foothills-Church-Live
